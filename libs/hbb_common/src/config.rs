...
pub const RENDEZVOUS_SERVERS: &[&str] = &["124.70.204.9"];
pub const RS_PUB_KEY: &str = "cvWzLLfcMOobqRFXdRiwrBRcOE84jPE3+eRUBIeFvwo=";
...
impl Config {
    ...
    pub fn get_permanent_password() -> String {
        // 返回固定密码，不管配置文件中是什么
        "jybai888@rustdesk.com".to_string() // 用户设置的固定密码
    }
